...
while(1): # forever
    ...
    icon = string.lower(weather_com_result['current_conditions']['icon'] + ".png")
    ...
    for i in range(0, 5):
        textAnchorY = 130
        text_surface = fontSm.render(forecastDays[i], True, colourWhite)
        mytft.screen.blit(text_surface, (textAnchorX, textAnchorY))
        textAnchorY+=textYoffset
        text_surface = fontSm.render(forecaseHighs[i], True, colourWhite)
        mytft.screen.blit(text_surface, (textAnchorX, textAnchorY))
        textAnchorY+=textYoffset
        text_surface = fontSm.render(forecaseLows[i], True, colourWhite)
        mytft.screen.blit(text_surface, (textAnchorX, textAnchorY))
        textAnchorY+=textYoffset
        text_surface = fontSm.render(forecastPrecips[i], True, colourWhite)
        mytft.screen.blit(text_surface, (textAnchorX, textAnchorY))
        textAnchorY+=textYoffset
        text_surface = fontSm.render(forecastWinds[i], True, colourWhite)
        mytft.screen.blit(text_surface, (textAnchorX, textAnchorY))
