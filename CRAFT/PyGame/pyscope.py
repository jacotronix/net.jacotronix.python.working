...
text_surface = font.render('Millie Jackson smells of Poo!', True, (255, 255, 255))  # White text
# Blit the text at 10, 0
scope.screen.blit(text_surface, (20, 100))
# Render the Adafruit logo at 10,360
#logo = pygame.image.load('raspberry_pi_adafruit_logo.gif').convert()
#scope.screen.blit(logo, (50, 50))
pygame.display.update()
